...
document.addEventListener("DOMContentLoaded", function(event){
    ...
    for (let superhero of superheroes) {
        ...
        <div class="info">Вселенная: ${superhero.universe}</div>
        <div class="info">Род деятельности: ${superhero.activity}</div>
        <div class="info">Суперсилы: ${superhero.superpower}</div>
        <div class="info">Подробнее: ${superhero.information}</div>
        <img src=${superhero.photo}>
        <div class="usergrade">
        <label for="grade">Ваша оценка от 0 до 5, где 0 – совсем не нравится, 5 – супергерой моей мечты:</label>
        <input type="text" class="grade">
        <input type="button" value="Сохранить" class="addBtn">
        </div>
        </div>`
    }

    document.getElementById("superheroesContainer").innerHTML = superheroesContent;
